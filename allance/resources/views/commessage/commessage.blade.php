<div class="col-sm-10 follow_left">
    ...
    <div class="jobs_follow jobs-single-item" id="commessage">
		...
		<h6 class="title"><a href="#">{{$val['m_name']}}</a>   <font color="#FF66FF">  <a href="javascript:void(0)" onclick="deliver('{{$val['mes_id']}}')" style="color:#FF6600;float:right;">投个简历</a></font> </h6>
		<span class="title">
